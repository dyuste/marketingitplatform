...
export class BsTextField extends Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		...
		return (
			<div className="form-group">
				...
				<input type="text" className="form-control" aria-describedby={this.props.name + "_hint"} name={this.props.name} id={this.props.name} value={this.props.value} onChange={(e) => this.props.onChange(e.target.value)} disabled={!!this.props.disabled}/>
